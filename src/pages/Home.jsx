    ...
    return (
        <>
            <div className="slider-game">
                <button type="button" className="btn btn-light ml-2 my-3 type-game">Featured Games</button>
                <Slider {...settings}>
            ...
            <div className="slider-game">
                <button type="button" className="btn btn-light ml-2 my-3 type-game">New Games</button>
                <Slider {...settings}>
